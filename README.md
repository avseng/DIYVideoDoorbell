**<h1>DIY Video Doorbell</h1>**

Powered by a Raspberry Pi 4 and a wide angle rpi camera module 3, this system features a full 7-inch touch display. On boot, it loads a sleek dashboard with a vector clock, real-time date, and network details.
